        ...
        <nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="http://127.0.0.1:8000/">HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="">ABOUT US</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="http://127.0.0.1:8000/services">SERVICES</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="#">NEWS/EVENTS</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="http://127.0.0.1:8000/ContactUs">CONTACT US</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand px-5 py-3" href="#">FEED</a>
                        </li>
                    </ul>
                </div>
            </div>
